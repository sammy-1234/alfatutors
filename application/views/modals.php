...
<div class="col-xs-4">
<div class="form-group has-success">
<?php echo form_dropdown('category',$categoryoptions,'individual',array(
'class'=>'form-control',
'id'=>'categorymenu'
));?>
</div>
...
<div class="col-xs-4"></div>
<div class="col-xs-4">
<label for="locationmenu"><h3>Choose one :</h3></label>
</div>
</div>
<div class="row">
...
<label id="days" for="chooseday"><h3>Wednessday</h3></label>
<?php echo form_checkbox('dayselection[]','Wednessday',FALSE,array(
'class'=>'form_control',
'id'=>'chooseday'
)); ?>
...
<!--when model ends - where model not yet there-->